...
export const main = Reach.App(() => {
  ...
  // }
  invariant(balance() >= ((2 * budget)), "The contract should be deployed with the budget")
  ...
  const [toA, toB] = outcome == 0 ? [1, 0] : outcome == 1 ? [0, 1] : [0, 0.5];
...
// })
// const board = Array.replicate(9, " ")
// const squareCostArray = array(UInt, [3, 2, 3, 2, 4, 2, 3, 2, 3])
